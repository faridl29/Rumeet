...
public class FragmentTabDetailBookingPending extends Fragment {
    ...
    private void refresh(){
        ...
        Call<GetBooked> bookedCall = mApiInterface.getBookedPending(sharedPrefManager.getSpIdRuangan());
        bookedCall.enqueue(new Callback<GetBooked>() {
            ...
            public void onResponse(Call<GetBooked> call, Response<GetBooked> response) {
                ...
                Log.d("Retrofit get", "ini tab detail pending");
