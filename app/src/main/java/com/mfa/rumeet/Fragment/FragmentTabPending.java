...
public class FragmentTabPending extends Fragment {
        ...
        public FragmentTabPending(){

        }

        public static FragmentTabPending getInstance(){
            return new FragmentTabPending();
        }
        ...
        private void refresh(){
            ...
            Call<GetBooked> bookedCall = mApiInterface.getJadwal(sharedPrefManager.getSpUniqueId(),"Pending");
            bookedCall.enqueue(new Callback<GetBooked>() {
                ...
                public void onResponse(Call<GetBooked> call, Response<GetBooked> response) {
                    ...
                    Log.d("Retrofit get", "ini tab pending");
                    AdapterJadwal adapter = new AdapterJadwal(bookedList, con);
                    if(bookedList.size() == 0){
                        textDataKosong.setText("Tidak ada data booking pending!");
